...
<div class="input-group">
  ...
  <input type="number" class="form-control" placeholder="N" required name="nHijos" id="n2d" min="0">
</div>
...
<div class="input-group">
  ...
  <input type="text" class="form-control" placeholder="Nombre completo" required  name="avisarNombre" id="correoIn" required>
</div>
<div class="input-group">
  <span class="input-group-text">Teléfono</span>
  <input type="number" class="form-control" placeholder="Teléfono" required  name="avisarTelefono" id="tel" min="0" required>
</div>
		<br>
